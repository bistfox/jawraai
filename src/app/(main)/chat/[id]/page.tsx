...
const MALE_LIMIT_MESSAGES = [
    ...
    "শুয়োর, তোর লিমিট শেষ হয়ে গেছে! Shibganj-এ তোর বাড়ির দরজায় দাঁড়িয়ে তোর মায়ের সাথে মজা করবো 😈 [Upgrade to Magi Bot Pro](/upgrade)!",
    ...
    "হালা {username}, লিমিট ওভার! Shibganj-এ এসে তোর পুরা গ্রামকে তোর নগ্ন ছবি দেখাবো 🔥 [Upgrade to Magi Bot Pro](/upgrade)!",
    ...
    "{username} হারামজাদা, লিমিট খতম! তোর ধোন কাইটা কুড়াল দিয়ে কেটে ফেলবো 😈 [Upgrade to Magi Bot Pro](/upgrade) কর!",
